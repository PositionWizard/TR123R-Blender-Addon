...
updater.addon = "io_tombraider123r"
...
def register(bl_info):
    ...
    updater.user = "PositionWizard"

    # Choose your own repository, must match git name for GitHUb and Bitbucket,
    # for GitLab use project ID (numbers only).
    updater.repo = "TR123R-Blender-Addon"

    # updater.addon = # define at top of module, MUST be done first

    # Website for manual addon download, optional but recommended to set.
    updater.website = "https://github.com/PositionWizard/TR123R-Blender-Addon"

    # Addon subfolder path.
    # "sample/path/to/addon"
    # default is "" or None, meaning root
    updater.subfolder_path = "io_scene_TRR1-3/"
    ...
    updater.overwrite_patterns = ["*.png", "*.jpg", "README.md", "LICENSE.txt", "*.xml"]
